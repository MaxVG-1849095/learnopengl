...
int main()
{
    ...
    Shader lightingShader("multipleLightShader.vs", "multipleLightShader.fs"); // you can name your shader files however you like
    ...
    while (!glfwWindowShouldClose(window)) // render loop
    {
        ...
        */
        ...
        if(flashlight){
            ...
            lightingShader.setVec3("spotLight.direction", cam.getCameraFront());
        ...
        lightingShader.setBool("spotLight.flashlightOn", flashlight);
